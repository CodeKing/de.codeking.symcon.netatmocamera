...
class splNetatmoAPI
{
    ...
    public function getThermoDevices() //--------Untested!!!
    {
        ...
        if (!isset($this->_thermoDatas['body']['devices'])) return ['No thermostats found.'];
